...
label_descriptions = {
    ...
    4: ('일어났어요! 개운해 👼🏻 마음이 편안해요 ☺️', """
        ...
        """),
    5: ('안정감을 찾거나 잠들고 싶어요! 배고파요 😫', """
        \n- 영아기의 아이들이 손가락 또는 손을 빠는 것은 배고픔이 행동으로 드러난 것일 수 있습니다.
        \n- 또는 아이들은 젖이나 우유병 등을 빨며 잠들기 때문에 빨기 반사를 수면의 초기 반사와 연관시키게 됩니다.
        \n- 잠을 청하고 싶거나 스트레스 상황에 놓여 있는 등, 진정이 필요한 상황이라고 이해할 수 있습니다. 
        """)
}
...
def load_models():
    ...
    return svm_model, svm_scaler, rf_model, rf_scaler
